    ...
    <div name="home" className='h-screen w-full  bg-gradient-to-b from-black via-black to-gray-800'>
        ...
        flex-col items-center justify-center h-full px-4 md:flex-row'>
            ...
            <div className='flex flex-col justify-center h-full'>
                <h2 className='text-4xl sm:text-4xl font-bold text-white'>Hi I Am,<br/>  Front End Developer</h2>
            ...
            <div>
                <img src={DLNEW} alt="my profile"  className='rounded-10xl px-2 mx-auto w-2/3 ml-3 md:w-full'/>
            </div>
