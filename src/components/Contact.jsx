    ...
    bg-gradient-to-b from-black to-gray-800 p-4 text-white'>
        ...
        max-w-screen-lg mx-auto h-full'>
            <div className='pb-8'>
                ...
                <p className='py-6 contact'><b>Contact Me: </b>+91 6398012953</p>
            </div>

            <div className='flex justify-center items-center'>
                <form action="https://getform.io/f/4f6150f1-66dd-4957-880f-01858ca558d4" method="POST" className='flex flex-col w-full md:w-1/2'>
                    ...
                    from-cyan-500 to-blue-800 px-6 py-3 my-8 mx-auto
